...
type OrderResponse struct {
	...
	Status  string `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"` // 订单状态
...
var file_orders_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x72, 0x5f, 0x6d, 0x61, 0x69, 0x6e, 0x42, 0x16, 0x5a, 0x14, 0x2e, 0x2e, 0x2f, 0x73,
